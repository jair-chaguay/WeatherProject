      ...
      */
      ...
      let arrayObjects = Array.from(xml.getElementsByTagName("time")).map(
        (timeElement) => {
          ...
          let windDirection =
            timeElement.getElementsByTagName("windDirection")[0].getAttribute("deg") +
            " " +
            timeElement.getElementsByTagName("windDirection")[0].getAttribute("code");
      ...
      let arrayObjectsG = Array.from(xml.getElementsByTagName("time")).map(
        (timeElement) => {
      ...
      /* Actualice de la variable de estado mediante la función de actualización */
