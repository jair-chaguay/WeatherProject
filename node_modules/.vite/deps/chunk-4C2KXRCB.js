...
var Menu = React4.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React4.Children.map(children, (child, index2) => {
...
var TextareaAutosize = React72.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const calculateTextareaStyles = React72.useCallback(() => {
...
var InputBase = React77.forwardRef(function InputBase2(inProps, ref) {
  ...
  return (0, import_jsx_runtime56.jsxs)(React77.Fragment, {
...
var OutlinedInput = React81.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime61.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime61.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime60.jsxs)(React81.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-4C2KXRCB.js.map
