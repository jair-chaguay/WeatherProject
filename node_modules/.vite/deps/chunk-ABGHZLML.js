...
var SvgIcon = React7.forwardRef(function SvgIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSvgIcon"
  });
  ...
  const hasSvgAsChild = React7.isValidElement(children) && children.type === "svg";
  const ownerState = _extends({}, props, {
    color,
    component,
    fontSize,
  ...
  return (0, import_jsx_runtime9.jsxs)(SvgIconRoot, _extends({
    as: component,
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime10.jsx)(SvgIcon_default, _extends({
  ...
  return React8.memo(React8.forwardRef(Component));
}
...
//# sourceMappingURL=chunk-ABGHZLML.js.map
